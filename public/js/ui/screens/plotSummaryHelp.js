...
export function render(container) {
  ...
  const sections = [
    ...
    helpSection("The Yield & Moisture by Position Charts", [
      ...
      p("A check mark in place of a position number under a bar means that hybrid is entered at more than one position in this plot — a repeated \"check\" hybrid (its rows in Ranked Results say \"Check\" instead of \"Entry\" too). Since those bars share the same genetics, differences BETWEEN them are almost purely the field talking, which makes them the best reference for judging how much a trend is ground versus genetics."),
